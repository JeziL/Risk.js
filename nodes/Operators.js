...
function MathOp() {
    ...
    this.op_widget = this.addWidget("combo", "Operation", this.properties.op, { property: "op", values: ["clz32","sign","log10","log2","log1p","expm1","cosh","sinh","tanh","acosh","asinh","atanh","trunc","fround","cbrt","abs","acos","asin","atan","ceil","cos","exp","floor","log","round","sin","sqrt","tan"] } );
    ...
    if (!this.rv) {
        ...
        if (A !== undefined && B !== undefined) {
            ...
            switch (this.properties.OP) {
                case ">":
                    this.rv = new RandomVariable(null, ctx, () => (
                        A.sample() > B.sample() ? 1 : 0
                    ));
                    break;
                case "<":
                    this.rv = new RandomVariable(null, ctx, () => (
