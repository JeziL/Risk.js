class RandomVariable {
    ...
    add(other) {
        return new RandomVariable(null, this.context, () => (
    ...
    pow(other) {
        return new RandomVariable(null, this.context, () => (
            Math.pow(this.sample(), other.sample())
        ));
    }
    ...
    static min(a, b) {
        return new RandomVariable(null, a.context ? a.context : b.context, () => (
            Math.min(a.sample(), b.sample())
        ));
    }

    static max(a, b) {
        return new RandomVariable(null, a.context ? a.context : b.context, () => (
            Math.max(a.sample(), b.sample())
        ));
    }
}
...
Number.prototype.add = function (rv) {
    return new RandomVariable(null, rv.context, () => (
        rv.sample() + this.valueOf()
    ));
}

Number.prototype.substract = function (rv) {
    return new RandomVariable(null, rv.context, () => (
        this.valueOf() - rv.sample()
    ));
}
...
Number.prototype.pow = function (rv) {
    return new RandomVariable(null, rv.context, () => (
        Math.pow(this.valueOf(), rv.sample())
    ));
}
