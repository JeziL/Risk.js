...
function SimulationCounter() {
  ...
  this.addWidget('number', 'times', this.properties.times, 'times', {
    precision: 0,
    step: 10,
    min: 0
  });
  this.iterWidget = this.addWidget('text', 'current', this.properties.counter, 'counter');
}
...
SimulationCounter.prototype.onStart = function () {
  ...
  this.iterWidget.value = this.properties.counter;
};
